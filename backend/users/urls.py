...
from .views import RegisterView, MeView, MyProfileView, UpdateMyDetailsView, UploadMyPhotoView, ChangePasswordView, PasswordResetRequestAPIView, PasswordResetConfirmAPIView
